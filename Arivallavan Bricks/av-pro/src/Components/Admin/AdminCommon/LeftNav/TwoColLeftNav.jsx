...
<div id="layout-wrapper">
  ...
  <div className="container-fluid">
    <div id="two-column-menu">
      <ul
        className="twocolumn-iconview simplebar-scrollable-y"
        data-simplebar="init"
      >
                ...
                <div className="simplebar-content" style={{ padding: 0 }}>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-dashboards" className="d-none">
                        Dashboards
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-apps" className="d-none">
                        Apps
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-layouts" className="d-none">
                        Layouts
                      </span>{" "}
                      <span
                        className="badge badge-pill bg-danger d-none"
                        data-key="t-hot"
                      >
                        Hot
                      </span>
                  ...
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-authentication" className="d-none">
                        Authentication
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-pages" className="d-none">
                        Pages
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-landing" className="d-none">
                        Landing
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-base-ui" className="d-none">
                        Base UI
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-advance-ui" className="d-none">
                        Advance UI
                      </span>
                    </a>
                  </li>
                  <li>
                    <a className="nav-icon" href="widgets.html">
                      <i className="ri-honour-line" />{" "}
                      <span data-key="t-widgets" className="d-none">
                        Widgets
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-forms" className="d-none">
                        Forms
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-tables" className="d-none">
                        Tables
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-charts" className="d-none">
                        Charts
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-icons" className="d-none">
                        Icons
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-maps" className="d-none">
                        Maps
                      </span>
                    </a>
                  </li>
                  <li>
                    ...
                    >
                      ...
                      <span data-key="t-multi-level" className="d-none">
                        Multi Level
                      </span>
                    </a>
                  </li>
          ...
          <div className="simplebar-offset" style={{ right: 0, bottom: 0 }}>
            ...
            >
              <div className="simplebar-content" style={{ padding: 0 }}>
                ...
                <li className="nav-item twocolumn-item-show">
                  <div
                ...
                <li className="nav-item">
                  <div
                    className="menu-dropdown active collapse"
                    id="sidebarApps"
                    aria-expanded="false"
                    style={{}}
                  >
                ...
                {/* end Dashboard Menu */}
                <li className="menu-title">
                  <i className="ri-more-fill" aria-expanded="false" />{" "}
